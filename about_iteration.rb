...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # ANSWER: It rolls over the array one element at a time, performing an
    # action on that element with the previous result. The result is
    # bootstrapped for the first element with the parameter to inject().
  end
  ...
  # ANSWER: This way the file is closed and cleaned up post-iteration
end
